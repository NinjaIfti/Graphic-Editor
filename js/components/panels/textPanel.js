...
export const textPanelComponent = function() {
    return {
        ...
        init() {
            ...
            console.log("Text panel component initialized");
        },
        ...
        callCanvasManagerMethod(methodName, args) {
            console.log(`Dispatching canvas:${methodName} event with args:`, args);
        ...
        addText(type = 'paragraph') {
            console.log(`addText called with type: ${type}`);
         ...
         */
        addHeading(type) {
            console.log(`addHeading called with type: ${type}`);
            this.addText(type);
        },
        ...
        updateTextProperty(property, value) {
            console.log(`updateTextProperty: ${property} = ${value}`);
         ...
         */
        updateTextRotation() {
            console.log(`updateTextRotation: ${this.textProperties.rotation}`);
            this.callCanvasManagerMethod('updateTextRotation', [this.textProperties.rotation]);
        },
         ...
         */
        toggleFontWeight() {
            console.log(`toggleFontWeight from: ${this.textProperties.fontWeight}`);
            this.textProperties.fontWeight = this.textProperties.fontWeight === 'bold' ? 'normal' : 'bold';
            console.log(`toggleFontWeight to: ${this.textProperties.fontWeight}`);
         ...
         */
        toggleFontStyle() {
            console.log(`toggleFontStyle from: ${this.textProperties.fontStyle}`);
            this.textProperties.fontStyle = this.textProperties.fontStyle === 'italic' ? 'normal' : 'italic';
            console.log(`toggleFontStyle to: ${this.textProperties.fontStyle}`);
         ...
         */
        toggleUnderline() {
            console.log(`toggleUnderline from: ${this.textProperties.underline}`);
            this.textProperties.underline = !this.textProperties.underline;
            console.log(`toggleUnderline to: ${this.textProperties.underline}`);
         ...
         */
        toggleShadow() {
            console.log(`toggleShadow: ${this.textProperties.shadowEnabled}`);
            this.callCanvasManagerMethod('toggleShadow', [this.textProperties.shadowEnabled]);
        },
        ...
        updateShadow(property, value) {
            console.log(`updateShadow: ${property} = ${value}`);
        ...
        updateTextCurve(value) {
            console.log(`updateTextCurve: ${value}`);
