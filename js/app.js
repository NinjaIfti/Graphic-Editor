...
document.addEventListener('alpine:init', () => {
    ...
    Alpine.data('steveEditor', () => ({
        ...
        handleObjectModified(e) {
            ...
            window.dispatchEvent(new CustomEvent('object:modified', {
                detail: e.target
            }));
        },
...
Alpine.data('textPanel', () => ({
    ...
    updateShadow(property, value) {
        ...
        this.textProperties[propName] = property === 'color' ? value : parseFloat(value);
...
Alpine.data('uploadsPanel', () => ({
    ...
    updateShadow(property, value) {
        ...
        // Update local state
        const propName = `shadow${property.charAt(0).toUpperCase() + property.slice(1)}`;
        this.objectProperties[propName] = property === 'color' ? value : parseFloat(value);
...
Alpine.data('settingsPanel', () => ({
    ...
    canvasSizes: [
        ...
        { name: 'Instagram Story (1080x1920)', value: '1080x1920', key: 'ig-story' },
        ...
        { name: 'YouTube Channel Art (2560x1440)', value: '2560x1440', key: 'yt-art' },
...
Alpine.data('quickOptionsBar', () => ({
    ...
    applyCrop() {
        ...
        const image = window.canvas.getObjects().find(obj => obj.type === 'image');
        if (!image) {
            this.resetCrop();
            return;
        }
