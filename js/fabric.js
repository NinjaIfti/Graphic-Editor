...
import clipArtsComponent from "./components/clip-arts";
        ...
        case "centerH":
          ...
          objects.forEach((obj) => {
            obj.set({
              left:
                obj.left +
                (selectionCenterX - (obj.left + (obj.width * obj.scaleX) / 2)),
            });
          });
          break;
        ...
        case "right":
          ...
          objects.forEach((obj) => {
            ...
            obj.set({
              left:
                obj.left +
                (maxRight - (boundingRect.left + boundingRect.width)) +
                (obj.width * obj.scaleX) / 2 -
                objWidth / 2,
            });
          });
        ...
        case "centerV":
          ...
          objects.forEach((obj) => {
            obj.set({
              top:
                obj.top +
                (selectionCenterY - (obj.top + (obj.height * obj.scaleY) / 2)),
            });
          });
          break;
        ...
        case "bottom":
          ...
          objects.forEach((obj) => {
            ...
            obj.set({
              top:
                obj.top +
                (maxBottom - (boundingRect.top + boundingRect.height)) +
                (obj.height * obj.scaleY) / 2 -
                objHeight / 2,
            });
          });
            ...
            if (imgData.src) {
              ...
              FabricImage.fromURL(
                ...
                (img) => {
                  ...
                  if (imgData.filters && imgData.filters.length > 0) {
                    ...
                    for (const filterData of imgData.filters) {
                      ...
                      switch (filterData.type) {
                        ...
                        case "Blur":
                          newFilters.push(
                            new filters.Blur({ blur: filterData.blur || 0.5 })
                          );
                          break;
                        case "Brightness":
                          newFilters.push(
                  ...
                  if (
                    this.uploads &&
                    typeof this.uploads.imageAdded === "function"
                  ) {
                    this.uploads.imageAdded(img);
                  }
                },
